...
public class TerrainEBSilverPineForest extends TerrainBase
{
	...
	public TerrainEBSilverPineForest(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainEBSilverPineForest(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
