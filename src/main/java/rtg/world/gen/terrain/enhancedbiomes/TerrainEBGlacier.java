...
public class TerrainEBGlacier extends TerrainBase
{
    ...
    public TerrainEBGlacier(float mountainWidth, float mountainStrength, float depthLake)
    {
    
        this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
    }
    
    public TerrainEBGlacier(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
    {
