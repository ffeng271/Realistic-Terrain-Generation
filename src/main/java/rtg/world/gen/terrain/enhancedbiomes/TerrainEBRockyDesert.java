...
public class TerrainEBRockyDesert extends TerrainBase
{
    ...
    public TerrainEBRockyDesert(float mountainWidth, float mountainStrength, float depthLake)
    {
    
        this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
    }
    
    public TerrainEBRockyDesert(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
    {
