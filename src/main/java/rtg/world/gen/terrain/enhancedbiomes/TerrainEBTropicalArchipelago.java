...
public class TerrainEBTropicalArchipelago extends TerrainBase
{
	...
	public TerrainEBTropicalArchipelago(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainEBTropicalArchipelago(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
