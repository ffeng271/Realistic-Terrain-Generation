...
public class TerrainEBMountainsEdge extends TerrainBase
{
	...
	public TerrainEBMountainsEdge(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainEBMountainsEdge(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
