...
public class TerrainEBMountainousArchipelago extends TerrainBase
{
	...
	public TerrainEBMountainousArchipelago(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainEBMountainousArchipelago(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
