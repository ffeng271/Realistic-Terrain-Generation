...
public class TerrainEBSilverPineHills extends TerrainBase
{
	...
	public TerrainEBSilverPineHills(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
	}
	
	public TerrainEBSilverPineHills(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
