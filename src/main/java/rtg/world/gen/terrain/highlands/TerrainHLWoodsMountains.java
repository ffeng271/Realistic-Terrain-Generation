...
public class TerrainHLWoodsMountains extends TerrainBase
{
    ...
    public TerrainHLWoodsMountains(float mountainWidth, float mountainStrength, float depthLake)
    {
        this(mountainWidth, mountainStrength, depthLake, 260f, 68f);
    }
    
    public TerrainHLWoodsMountains(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
    {
        width = mountainWidth;
