...
public class SurfaceHLSnowMountains extends SurfaceBase
{
	...
	public SurfaceHLSnowMountains(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceHLSnowMountains(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
