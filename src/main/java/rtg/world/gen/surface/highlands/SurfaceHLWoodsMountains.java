...
public class SurfaceHLWoodsMountains extends SurfaceBase
{
    ...
    public SurfaceHLWoodsMountains(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
    {
        super(top, fill);
        beach = genBeach;
    ...
    public SurfaceHLWoodsMountains(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
    {
