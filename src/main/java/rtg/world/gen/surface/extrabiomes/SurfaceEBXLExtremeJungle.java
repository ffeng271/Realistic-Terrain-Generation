...
public class SurfaceEBXLExtremeJungle extends SurfaceBase
{
	...
	public SurfaceEBXLExtremeJungle(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceEBXLExtremeJungle(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
