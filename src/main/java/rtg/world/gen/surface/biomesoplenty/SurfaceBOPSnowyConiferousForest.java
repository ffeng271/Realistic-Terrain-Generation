...
public class SurfaceBOPSnowyConiferousForest extends SurfaceBase
{
	...
	public SurfaceBOPSnowyConiferousForest(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceBOPSnowyConiferousForest(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float snowCliff, float snowHeight, float snowStrength, float clayCliff)
	{
