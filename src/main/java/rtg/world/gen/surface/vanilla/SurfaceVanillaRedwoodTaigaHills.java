...
public class SurfaceVanillaRedwoodTaigaHills extends SurfaceBase
{
    ...
    public SurfaceVanillaRedwoodTaigaHills(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff)
    {
    ...
    public SurfaceVanillaRedwoodTaigaHills(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff,
