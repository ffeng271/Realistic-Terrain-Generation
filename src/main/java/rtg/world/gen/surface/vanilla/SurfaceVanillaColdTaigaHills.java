...
public class SurfaceVanillaColdTaigaHills extends SurfaceBase
{
    ...
    public SurfaceVanillaColdTaigaHills(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff)
    {
    ...
    public SurfaceVanillaColdTaigaHills(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff,
